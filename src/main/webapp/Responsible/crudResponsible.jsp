...
<div class="container col-md-8 col-md-offset-3" style="overflow: auto">
    ...
    <div class="flex flex-row ">
                ...
                >
                    <div class="space-y-6 md:space-y-10 mt-10">
                        ...
                        <div id="menu" class="flex flex-col space-y-2">
                            ...
                            >
                                <svg
                                        class="mr-3 w-6 h-6 fill-current inline-block"
                                        fill="currentColor"
                                        viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg"
                                >
                                ...
                                <button type="button"  data-modal-toggle="promotion">
                                    Add promotion
                                </button>
                            </div>
                            <div
                            ...
                            >
                                ...
                                <button type="button"  data-modal-toggle="addResponsible">
                                    Add Responsible
                                </button>
                            </div>

                            <div class=" flex text-sm font-medium text-gray-700 py-2 px-2 hover:bg-blue-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
                            >
                                <svg aria-hidden="true" class="flex-shrink-0 mr-3 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zm10.293 9.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L14.586 9H7a1 1 0 100 2h7.586l-1.293 1.293z" clip-rule="evenodd"></path></svg>
                                <a href="${pageContext.request.contextPath}/Login" class="">log out</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Main modal -->
        <div id="promotion" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <form action="${pageContext.request.contextPath}/promotion/createPromotion" method="post">
                            <div class="relative z-0 mb-6 w-full group">
                                <input type="text" name="name" id="promotionName"
                            ...
                            <div class="relative z-0 mb-6 w-full group">
                                <input type="number" max="50" name="percentage" id="percentage"
                                       class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                       placeholder=" " required="">
                            ...
                            <div class="relative z-0 mb-6 w-full group">
                                <label for="subcategory" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Subcategory</label>
                                <select name="subcategory" id="subcategory" required class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" >
                                    <%
                                        try {
                                            List<SubcategoryEntity> subCategories = (ArrayList<SubcategoryEntity>) request.getAttribute("subCategories");
                                            if(subCategories==null){
                                                out.print("nothing to print");
                                            }else{
                                                for(SubcategoryEntity s:subCategories){ %>

                                    <option value="<%=  s.getIdsubcategory() %>"><%=  s.getName() %> </option>
                                    <%   }
                                    }
                                    }catch (Exception e) {
                                        e.getStackTrace();
                            ...
                            <div class="relative z-0 mb-6 w-full group">
                                ...
                                <select name="category" id="IdCategory" required class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" >
                                    <%
                                        try {
                                            List<CategoryEntity> categories = (ArrayList<CategoryEntity>) request.getAttribute("categories");
                                            if(categories==null){
                                                out.print("nothing to print");
                                            }else{
                            ...
                            <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                                <button type="submit"
                                        ...
                                        data-modal-toggle="promotion">Submit
                                </button>
        ...
        <!-- Main modal -->
        <div id="addResponsible" tabindex="-1" aria-hidden="true"
             class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                        ...
                        <button type="button"
                                ...
                                data-modal-toggle="addResponsible">
                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                      d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
...
<%--                            </div>--%>
                            <div class="relative z-0 mb-6 w-full group">
                                <label for="IdCategory" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Store id</label>
                                <select id="IdCategory" required class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" name="IdCategory">
                                    <%
                                        try {
                                            List<CategoryEntity> categories = (ArrayList<CategoryEntity>) request.getAttribute("categories");
                                            if(categories==null){
...
<%--                                </div>--%>
                            ...
                            <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                                <button type="submit"
                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                        data-modal-toggle="addResponsible">Submit
                                </button>
            ...
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <form action="${pageContext.request.contextPath}/CrudResponsible/updateResponsible"
                              method="post">
                            <div class="relative z-0 mb-6 w-full group">
                                <input type="text" name="fullname" id="fullnameE"
                                       class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                       placeholder=" " required="">
                                <label for="fullnameE"
                                       class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Fullname</label>
        ...
        <div class="mt-44 ml-11">
            <table class="max-w-5xl mx-auto table-auto">
                ...
                <tr class="bg-white border-b-2 border-gray-200">
                    ...
                    <td class="px-16 py-2">
                        <button type="button" class="idResponsible" data-modal-toggle="edit"
                                data-id="<%= s.getIduser() %>"><span> edit </span></button>
