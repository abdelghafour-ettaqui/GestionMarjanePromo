...
<div class="container col-md-8 col-md-offset-3" style="overflow: auto">
    ...
    <div class="flex flex-row">
                                        ...
                                        <div class="space-y-6 md:space-y-10 mt-10">
                                            ...
                                            <div id="menu" class="flex flex-col space-y-2">
                                                <div
                                                        ...
                                                        class="flex text-sm font-medium text-gray-700 py-2 px-2 hover:bg-blue-500 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out"
                                                >
                                                    ...
                                                    <button type="button" data-modal-toggle="addStoreAdmin">
                                                        Add store admin
                                                    </button>
                                                </div>
        ...
        <body class="antialiased bg-slate-200">
                                                                                                                                                ...
                                                                                                                                                <!-- Main modal -->
                                                                                                                                                <div id="addStoreAdmin" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                                                                                                                                                    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                                                                                                                                        ...
                                                                                                                                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                                                                                                                            ...
                                                                                                                                                            <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                                                                                                                                                                ...
                                                                                                                                                                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="addStoreAdmin">
                                                                                                                                                            ...
                                                                                                                                                            <div class="p-6 space-y-6">
                                                                                                                                                                ...
                                                                                                                                                                <form action="${pageContext.request.contextPath}/crudStoreAdmin/addStoreAdmin" method="post" >
                                                                                                                                                                    ...
                                                                                                                                                                    <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                                                                                                                                                                        <button  type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" data-modal-toggle="addStoreAdmin" >Submit</button>
